...
<?php if ($service) { ?>
        ...
        <div class="col-md-7">
            <ul class="list-group list-group-flush shadow-sm rounded">
                <li class="list-group-item">
                    ...
                    <strong>Категория:</strong> <?php echo htmlspecialchars($service['category']); ?>
                </li>
                <li class="list-group-item">
                    <i class="bi bi-gear-wide-connected text-primary"></i>
                    <strong>Тип услуга:</strong> <?php echo htmlspecialchars($service['subcategory']); ?>
                </li>
                <li class="list-group-item">
                    <i class="bi bi-geo-alt-fill text-primary"></i>
                    <strong>Локация:</strong> <?php echo htmlspecialchars($service['location']); ?>
                </li>
                <li class="list-group-item">
                ...
                <?php if (isset($_SESSION['user_id']) && isset($visitCount)) { ?>
                    <li class="list-group-item">
                        <i class="bi bi-eye text-primary"></i>
                        <strong>Брой посещения:</strong> <?php echo $visitCount; ?>
                    </li>
                <?php } ?>
            </ul>
        </div>
    ...
    <div class="mb-5">
        ...
        <?php if ($totalReviews > 0) { ?>
            <p><strong><?php echo $avgRating; ?></strong> от <strong><?php echo $totalReviews; ?></strong> ревюта</p>
    ...
    <!-- Форма за ревю -->
    <?php if (isset($_SESSION['user_id']) && !$reviewModel->hasReviewed($_SESSION['user_id'], $service['id'])) { ?>
...
<?php } else { ?>
    <div class="alert alert-warning">Услугата не е намерена.</div>
<?php } ?>
